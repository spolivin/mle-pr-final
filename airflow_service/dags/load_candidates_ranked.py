...
with DAG(
    ...
    extract_train_step = PythonOperator(task_id='extract_candidates_train', python_callable=extract_candidates_train)
    extract_inference_step = PythonOperator(task_id='extract_candidates_inference', python_callable=extract_candidates_inference)
    train_rank_step = PythonOperator(task_id='train_model_infer', python_callable=train_model_infer)
